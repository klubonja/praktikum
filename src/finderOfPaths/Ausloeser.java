...
public class Ausloeser {
	...
	public void zuweisung(){
		...
		gameView.getKomplettesFeld().getZug().YESgangImage.setOnMouseClicked(e -> {beweger.useSecretPassage();
		gameView.getKomplettesFeld().getChildren().remove(gameView.getKomplettesFeld().getZug());});
