...
//		testGUI.start();
//		spieler = testGUI.getSpieler();
//		dice(testGUI.getLabelArray()[spieler.getyPosition()][spieler.getxPosition()]);
//		for (int i = 0; i<testGUI.getLabelArray().length-1;i++){
//			for (int j = 0; j<testGUI.getLabelArray()[j].length-1;j++){
//				Kachel momentaneKachel = testGUI.getLabelArray()[i][j];
//					if (momentaneKachel.isIstRaum()==false){
...
//		System.out.println("move whatever");
//		
//		clearDice(testGUI.getLabelArray()[spieler.getyPosition()][spieler.getxPosition()]);
//		persil2(testGUI.getLabelArray()[spieler.getyPosition()][spieler.getxPosition()]);
//		dice(ziel);
//		
//		reset(spielerDarstellung,ziel);
//			
...
//						
//							Kachel erreichbareKachel = testGUI.getLabelArray()[iReihe][jSpalte];
