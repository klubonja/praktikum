...
public class TestGUI extends GridPane {
	...
	public void setLayout(){
		...
		for (int i = 0, reihe = 0, spalte = 0; i< labelArray.length;i++){
			String iString = +i/24 +" - " +i%24;
			labelArray[i] = new Label(iString);
			this.add(labelArray[i], i/24, i%24);			
		}
		labelAnfang = labelArray[0];
